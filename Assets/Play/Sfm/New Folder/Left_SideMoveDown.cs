...
public class Left_SideMoveDown : PlayerState
{
    CharacterController controller;

    float speed = 0.0f;

    public Left_SideMoveDown(PlayerManager _sceneManager, GameObject _gameObject, Animator _animator, CharacterController _controller, float _speed) : base(_sceneManager, pSCENE_STATE.Left_Side_Down_Move)
    {
