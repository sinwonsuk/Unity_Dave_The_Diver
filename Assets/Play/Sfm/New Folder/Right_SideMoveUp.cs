...
public class Right_SideMoveUp : PlayerState
{
    CharacterController controller;

    float speed = 0.0f;

    public Right_SideMoveUp(PlayerManager _sceneManager, GameObject _gameObject, Animator _animator,CharacterController _controller, float _speed) : base(_sceneManager, pSCENE_STATE.Right_Side_Up_Move)
    {
