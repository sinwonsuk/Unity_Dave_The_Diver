...
public class Left_Move : PlayerState
{
    ...
    public Left_Move(PlayerManager _sceneManager, GameObject _gameObject, Animator _animator ,Dictionary<string, GameObject> _dave_Child_dictory,CharacterController _controller,float _speed) : base(_sceneManager, pSCENE_STATE.Left_Move)
    {
